	...
	<body style="background-color:#BADB0B">
		...
		<div id="formulario">
				<form action="" method="post" >
					...
					<input type="text" name="id" id="blank">
					Ingrese nombre del libro:
					<input type="text" name="titulo" id="blank">
					Ingrese autor:
					<input type="text" name="autor" id="blank">
					Ingrese code ISBN:
					<input type="text" name="isbn" id="blank">
					<input type="submit" name="update" value ="Editar Libro" id="form" onclick="this.form.action='respuesta.php';this.form.submit();">
					<br>
